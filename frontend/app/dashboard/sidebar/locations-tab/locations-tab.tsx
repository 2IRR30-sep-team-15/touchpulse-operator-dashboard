...
const DarkInput = ({ placeholder, icon }: { placeholder: string, icon?: React.ReactNode }) => (
    ...
    return (
        <div className="flex flex-col h-full p-4 space-y-6 overflow-y-auto dark:text-white">
            ...
            <section className="space-y-4">
                ...
                {/* Route Name Input */}
                <DarkInput placeholder={defaultRouteName} icon={<Car className="w-5 h-5"/>} />
            ...
            <section className="space-y-4">
                <h2 className="text-lg font-semibold text-gray-500">Saved address book</h2>

                {savedLocations.length === 0 ? (
                    <p className="text-gray-500 italic pt-2">No saved locations found for this user.</p>
                ) : (
